...
public class ApplicationContextUtils {
     ...
     * logger.
     */
	private static final Logger logger = new LoggerImpl(org.esupportail.smsuapimail.business.context.ApplicationContextUtils.class);
	
	/**
	 * Use to initialise application context. 
	 */
	public static void initApplicationContext() {
		final ServletContext servletContext = SmsuApiMailServletContextListener.getServletContext();
